...
const makeMiddleEarth = () => {
  ...
  const middle_earth = "<section id='middle-earth'></section>"
...
const theBalrog = () => {
  ...
  $('#middle-earth .buddy:contains("Gandalf")').html('Gandalf the White');
  $('#middle-earth .buddy:contains("Gandalf the White")').addClass("the-white");
};
